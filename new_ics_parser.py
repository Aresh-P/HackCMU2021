    ...
    for name in names:
        ...
        for icsPath in os.listdir(f"{path}/{name}"): #want path in arg
            ...
            if fromSio(icsCal):
                ...
                goals = createStudentGoals(icsCal)

        group = createStudentGroup(name)
...
# print(os.listdir("/Users/lucaborletti/Desktop/Hack@CMU/names/luca"))
